  ...
  describe('Place', () => {
    ...
    test('should failed if out of table range', () => {
      return robot.place(1, 10, 'NORTH')
        ...
        .catch((error) => {
          expect(error.message).toEqual('Robot will fall from the table');
        });
    });
    ...
    test('should failed if invalid param for facing', () => {
      return robot.place(1, 1, 'anything')
        ...
        .catch((error) => {
          expect(error.message).toEqual('invalid param');
        });
    });
  ...
  describe('Move', () => {
    ...
    test('should failed if location is null', () => {
      return robot.move(null)
        ...
        .catch((error) => {
          expect(error.message).toEqual('Robot has not been placed on the table yet');
        });
    });
